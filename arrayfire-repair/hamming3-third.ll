...
%147 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE6s_dist, i32 0, i64 %146, !dbg !78
%148 = load i32* %147, align 4, !dbg !78
%149 = load i32* %tid, align 4, !dbg !78
%150 = zext i32 %149 to i64, !dbg !78
%151 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE6s_dist, i32 0, i64 %150, !dbg !78
...
br i1 %label272, label %154, label %273
br label %154
...
%158 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE6s_dist, i32 0, i64 %157, !dbg !79
%159 = load i32* %158, align 4, !dbg !79
%160 = load i32* %tid, align 4, !dbg !79
%161 = zext i32 %160 to i64, !dbg !79
%162 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE6s_dist, i32 0, i64 %161, !dbg !79
...
%166 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE5s_idx, i32 0, i64 %165, !dbg !81
%167 = load i32* %166, align 4, !dbg !81
%168 = load i32* %tid, align 4, !dbg !81
%169 = zext i32 %168 to i64, !dbg !81
%170 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE5s_idx, i32 0, i64 %169, !dbg !81
...
%175 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE6s_dist, i32 0, i64 %174, !dbg !83
%176 = load i32* %175, align 4, !dbg !83
%177 = load i32* %tid, align 4, !dbg !83
%178 = zext i32 %177 to i64, !dbg !83
%179 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE6s_dist, i32 0, i64 %178, !dbg !83
...
br i1 %label274, label %182, label %275
br label %182
...
%186 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE6s_dist, i32 0, i64 %185, !dbg !84
%187 = load i32* %186, align 4, !dbg !84
%188 = load i32* %tid, align 4, !dbg !84
%189 = zext i32 %188 to i64, !dbg !84
%190 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE6s_dist, i32 0, i64 %189, !dbg !84
...
%194 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE5s_idx, i32 0, i64 %193, !dbg !86
%195 = load i32* %194, align 4, !dbg !86
%196 = load i32* %tid, align 4, !dbg !86
%197 = zext i32 %196 to i64, !dbg !86
%198 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE5s_idx, i32 0, i64 %197, !dbg !86
...
%203 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE6s_dist, i32 0, i64 %202, !dbg !88
%204 = load i32* %203, align 4, !dbg !88
%205 = load i32* %tid, align 4, !dbg !88
%206 = zext i32 %205 to i64, !dbg !88
%207 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE6s_dist, i32 0, i64 %206, !dbg !88
...
br i1 %label276, label %210, label %277
br label %210
...
%214 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE6s_dist, i32 0, i64 %213, !dbg !89
%215 = load i32* %214, align 4, !dbg !89
%216 = load i32* %tid, align 4, !dbg !89
%217 = zext i32 %216 to i64, !dbg !89
%218 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE6s_dist, i32 0, i64 %217, !dbg !89
...
%222 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE5s_idx, i32 0, i64 %221, !dbg !91
%223 = load i32* %222, align 4, !dbg !91
%224 = load i32* %tid, align 4, !dbg !91
%225 = zext i32 %224 to i64, !dbg !91
%226 = getelementptr inbounds [256 x i32]* @_ZZ15hamming_matcherPjS_jjE5s_idx, i32 0, i64 %225, !dbg !91
...
; <label>:232                                     ; preds = %228
%233 = load i32* getelementptr inbounds ([256 x i32]* @_ZZ15hamming_matcherPjS_jjE6s_dist, i32 0, i64 0), align 4, !dbg !96
...
%242 = load i32* getelementptr inbounds ([256 x i32]* @_ZZ15hamming_matcherPjS_jjE5s_idx, i32 0, i64 0), align 4, !dbg !98
